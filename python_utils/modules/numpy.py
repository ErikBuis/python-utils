...
) -> list[tuple[npt.NDArray[NpGeneric1], npt.NDArray[NpGeneric2]]]:
    pass
...
def groupby(
    ...
    npt.NDArray[NpGeneric1], npt.NDArray[NpGeneric2], npt.NDArray[np.intp]
]:
    pass
    ...
    Returns:
        ...
        - If as_sequence is False, a tuple containing:
            ...
            - Array of values stored a packed manner, grouped by key. The first
                ...
                Shape: [N, **]
            - Array containing the number of values for each unique key.
                Shape: [U]

    Examples:
    >>> keys = np.array([4, 2, 4, 3, 2, 8, 4])
    >>> vals = np.array([
    ...     [0, 1],
    ...     [2, 3],
    ...     [4, 5],
