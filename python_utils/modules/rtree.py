...
def find_overlapping_bboxes(
    ...
    Returns:
        ...
        overlap with it. These indices are in no particular order, and include
        the index of the bounding box itself. The output could be seen as an
        adjacency list of the overlap graph.
    """
...
def find_overlapping_geometries(
    ...
    Args:
        ...
        binary_overlap_func: A function that returns True if two geometries
            overlap. The function is assumed to be symmetric, i.e.:
            binary_overlap_func(a, b) == binary_overlap_func(b, a).

    Returns:
        For each geometry, a list of indices of the geometries that overlap
        with it. These indices are in no particular order, and include the
        index of the geometry itself. The output could be seen as an adjacency
        list of the overlap graph.
    """
    overlaps = find_overlapping_bboxes(
...
def find_overlapping_circles(
    ...
    Args:
        circles: The circles to find overlaps in. Each circle is a tuple
            containing:
    ...
    Returns:
        ...
        These indices are in no particular order, and include the index of the
        circle itself. The output could be seen as an adjacency list of the
        overlap graph.
    """
